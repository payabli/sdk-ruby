...
require_relative "lib/payabli/version"
...
Gem::Specification.new do |spec|
  spec.name = "payabli"
  spec.authors = ["Payabli"]
  spec.version = Payabli::VERSION
  spec.summary = "Ruby client library for the Payabli API"
  spec.description = "The Payabli Ruby library provides convenient access to the Payabli API from Ruby."
