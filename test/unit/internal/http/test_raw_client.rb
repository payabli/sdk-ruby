...
describe Payabli::Internal::Http::RawClient do
  ...
  describe "#should_retry?" do
    let(:client) do
      Payabli::Internal::Http::RawClient.new(base_url: "https://example.com", max_retries: 3)
    end
  ...
  describe "#build_http_request auth header precedence" do
    let(:client) do
      Payabli::Internal::Http::RawClient.new(
        base_url: "https://example.com",
