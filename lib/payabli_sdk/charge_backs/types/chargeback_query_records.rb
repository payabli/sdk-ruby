  ...
  module ChargeBacks
    module Types
      class ChargebackQueryRecords < Internal::Types::Model
        ...
        field :customer, -> { PayabliSdk::Types::QueryTransactionPayorData }, optional: false, nullable: false, api_name: "Customer"
        field :payment_data, -> { PayabliSdk::Types::QueryPaymentData }, optional: false, nullable: false, api_name: "PaymentData"
        ...
        field :responses, -> { Internal::Types::Array[PayabliSdk::ChargeBacks::Types::ChargeBackResponse] }, optional: false, nullable: false, api_name: "Responses"
        field :transaction, -> { PayabliSdk::Types::TransactionQueryRecords }, optional: false, nullable: false, api_name: "Transaction"
        ...
        field :messages, -> { Internal::Types::Array[PayabliSdk::ChargeBacks::Types::ChargebackMessage] }, optional: false, nullable: false
