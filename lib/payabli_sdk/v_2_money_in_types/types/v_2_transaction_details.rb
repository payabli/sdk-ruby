...
module PayabliSdk
  module V2MoneyInTypes
    module Types
      # Complete transaction details returned by v2 Money In endpoints. This matches the structure of the transaction
      # details previously returned by the v1 details endpoint.
      class V2TransactionDetails < Internal::Types::Model
        ...
        field :payment_data, -> { PayabliSdk::MoneyIn::Types::TransactionDetailPaymentData }, optional: false, nullable: false, api_name: "paymentData"
        ...
        field :response_data, -> { PayabliSdk::V2MoneyInTypes::Types::V2TransactionDetailResponseData }, optional: false, nullable: false, api_name: "responseData"
        ...
        field :invoice_data, -> { PayabliSdk::MoneyIn::Types::TransactionDetailInvoiceData }, optional: false, nullable: false, api_name: "invoiceData"
        ...
        field :customer, -> { PayabliSdk::MoneyIn::Types::TransactionDetailCustomer }, optional: false, nullable: false
        field :split_funding_instructions, -> { Internal::Types::Array[PayabliSdk::Types::SplitFundingContent] }, optional: false, nullable: true, api_name: "splitFundingInstructions"
        field :cfee_transactions, -> { Internal::Types::Array[PayabliSdk::Types::QueryCFeeTransaction] }, optional: false, nullable: false, api_name: "cfeeTransactions"
        field :transaction_events, -> { Internal::Types::Array[PayabliSdk::MoneyIn::Types::TransactionDetailEvent] }, optional: false, nullable: false, api_name: "transactionEvents"
        ...
        field :ach_holder_type, -> { PayabliSdk::Types::AchHolderType }, optional: false, nullable: false, api_name: "achHolderType"
