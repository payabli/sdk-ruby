...
module PayabliSdk
  module TokenStorage
    class Client
      ...
      # @param params [PayabliSdk::TokenStorage::Types::RequestTokenStorage]
      ...
      # @option params [PayabliSdk::TokenStorage::Types::CreateAnonymous] :create_anonymous
      # @option params [Boolean, nil] :force_customer_creation
      # @option params [PayabliSdk::TokenStorage::Types::Temporary] :temporary
      # @option params [String, nil] :idempotency_key
      #
      # @return [PayabliSdk::TokenStorage::Types::AddMethodResponse]
      def add_method(request_options: {}, **params)
        ...
        request = PayabliSdk::Internal::JSON::Request.new(
          ...
          headers: headers,
          query: query_params,
          body: PayabliSdk::TokenStorage::Types::RequestTokenStorage.new(params).to_h,
        ...
        if code.between?(200, 299)
          PayabliSdk::TokenStorage::Types::AddMethodResponse.load(response.body)
        else
      ...
      #
      # @return [PayabliSdk::TokenStorage::Types::GetMethodResponse]
      def get_method(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          PayabliSdk::TokenStorage::Types::GetMethodResponse.load(response.body)
        else
          error_class = PayabliSdk::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      # @option params [String] :method_id
      #
      # @return [PayabliSdk::Types::PayabliApiResponsePaymethodDelete]
      def remove_method(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          PayabliSdk::Types::PayabliApiResponsePaymethodDelete.load(response.body)
        else
          error_class = PayabliSdk::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      def update_method(request_options: {}, **params)
        ...
        request = PayabliSdk::Internal::JSON::Request.new(
          ...
          path: "TokenStorage/#{params[:method_id]}",
          query: query_params,
          body: PayabliSdk::TokenStorage::Types::RequestTokenStorage.new(body_params).to_h,
          request_options: request_options
        )
        begin
          response = @client.send(request)
