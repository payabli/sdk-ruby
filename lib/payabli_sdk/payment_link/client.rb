...
module PayabliSdk
  module PaymentLink
    class Client
      ...
      # @param params [PayabliSdk::PaymentLink::Types::PaymentPageRequestBody]
      ...
      #
      # @return [PayabliSdk::PaymentLink::Types::PayabliApiResponsePaymentLinks]
      def add_pay_link_from_invoice(request_options: {}, **params)
        ...
        request = PayabliSdk::Internal::JSON::Request.new(
          ...
          headers: headers,
          query: query_params,
          body: PayabliSdk::PaymentLink::Types::PaymentPageRequestBody.new(body_params).to_h,
        ...
        if code.between?(200, 299)
          PayabliSdk::PaymentLink::Types::PayabliApiResponsePaymentLinks.load(response.body)
        else
      ...
      #
      # @return [PayabliSdk::PaymentLink::Types::GetPayLinkFromIdResponse]
      def get_pay_link_from_id(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          PayabliSdk::PaymentLink::Types::GetPayLinkFromIdResponse.load(response.body)
        else
          error_class = PayabliSdk::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      #
      # @param request_options [Hash]
      # @param params [PayabliSdk::Types::PushPayLinkRequest]
      # @option request_options [String] :base_url
      # @option request_options [Hash{String => Object}] :additional_headers
      # @option request_options [Hash{String => Object}] :additional_query_parameters
      # @option request_options [Hash{String => Object}] :additional_body_parameters
      ...
      def push_pay_link_from_id(request_options: {}, **params)
        ...
        request = PayabliSdk::Internal::JSON::Request.new(
          ...
          body: PayabliSdk::Types::PushPayLinkRequest.new(params).to_h,
          request_options: request_options
        )
        begin
          response = @client.send(request)
      ...
      #
      # @param request_options [Hash]
      # @param params [PayabliSdk::PaymentLink::Types::PayLinkUpdateData]
      # @option request_options [String] :base_url
      # @option request_options [Hash{String => Object}] :additional_headers
      # @option request_options [Hash{String => Object}] :additional_query_parameters
      # @option request_options [Hash{String => Object}] :additional_body_parameters
      ...
      def update_pay_link_from_id(request_options: {}, **params)
        ...
        request = PayabliSdk::Internal::JSON::Request.new(
          ...
          body: PayabliSdk::PaymentLink::Types::PayLinkUpdateData.new(body_bag).to_h,
          request_options: request_options
        )
        begin
          response = @client.send(request)
      ...
      # @option params [PayabliSdk::Types::Entry] :entry_point
