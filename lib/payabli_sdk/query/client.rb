...
module PayabliSdk
  module Query
    class Client
      ...
      # @option params [PayabliSdk::Types::Entry] :entry
      # @option params [PayabliSdk::Types::ExportFormat, nil] :export_format
      ...
      #
      # @return [PayabliSdk::QueryTypes::Types::QueryBatchesDetailResponse]
      def list_batch_details(request_options: {}, **params)
        ...
        if code.between?(200, 299)
          PayabliSdk::QueryTypes::Types::QueryBatchesDetailResponse.load(response.body)
        else
      ...
      # @option params [String, nil] :sort_by
      #
      # @return [PayabliSdk::Types::QueryResponseSettlements]
      def list_batch_details_org(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          PayabliSdk::Types::QueryResponseSettlements.load(response.body)
        else
          error_class = PayabliSdk::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      # @option params [String, nil] :sort_by
      #
      # @return [PayabliSdk::QueryTypes::Types::QueryBatchesResponse]
      def list_batches(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          PayabliSdk::QueryTypes::Types::QueryBatchesResponse.load(response.body)
        else
          error_class = PayabliSdk::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      # @option params [String, nil] :sort_by
      #
      # @return [PayabliSdk::Types::QueryBatchesOutResponse]
      def list_batches_out(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          PayabliSdk::Types::QueryBatchesOutResponse.load(response.body)
        else
          error_class = PayabliSdk::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      # @option params [String, nil] :sort_by
      #
      # @return [PayabliSdk::Types::QueryChargebacksResponse]
      def list_chargebacks(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          PayabliSdk::Types::QueryChargebacksResponse.load(response.body)
        else
          error_class = PayabliSdk::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      # @option params [String, nil] :sort_by
      #
      # @return [PayabliSdk::Types::QueryCustomerResponse]
      def list_customers(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          PayabliSdk::Types::QueryCustomerResponse.load(response.body)
        else
          error_class = PayabliSdk::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      # @option params [String, nil] :sort_by
      #
      # @return [PayabliSdk::Types::QueryResponseNotificationReports]
      def list_notification_reports(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          PayabliSdk::Types::QueryResponseNotificationReports.load(response.body)
        else
          error_class = PayabliSdk::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      # @option params [String, nil] :sort_by
      #
      # @return [PayabliSdk::Types::QueryResponseNotifications]
      def list_notifications(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          PayabliSdk::Types::QueryResponseNotifications.load(response.body)
        else
          error_class = PayabliSdk::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      # @option params [String, nil] :sort_by
      #
      # @return [PayabliSdk::QueryTypes::Types::ListOrganizationsResponse]
      def list_organizations(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          PayabliSdk::QueryTypes::Types::ListOrganizationsResponse.load(response.body)
        else
          error_class = PayabliSdk::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      # @option params [String, nil] :sort_by
      #
      # @return [PayabliSdk::Types::QueryPayoutTransaction]
      def list_payout(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          PayabliSdk::Types::QueryPayoutTransaction.load(response.body)
        else
          error_class = PayabliSdk::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      # @option params [String, nil] :sort_by
      #
      # @return [PayabliSdk::Types::QueryEntrypointResponse]
      def list_paypoints(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          PayabliSdk::Types::QueryEntrypointResponse.load(response.body)
        else
          error_class = PayabliSdk::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      # @option params [String, nil] :sort_by
      #
      # @return [PayabliSdk::Types::QuerySubscriptionResponse]
      def list_subscriptions(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          PayabliSdk::Types::QuerySubscriptionResponse.load(response.body)
        else
          error_class = PayabliSdk::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      # @option params [String, nil] :sort_by
      #
      # @return [PayabliSdk::Types::QueryResponseTransactions]
      def list_transactions(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          PayabliSdk::Types::QueryResponseTransactions.load(response.body)
        else
          error_class = PayabliSdk::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      # @option params [String, nil] :sort_by
      #
      # @return [PayabliSdk::QueryTypes::Types::QueryTransferDetailResponse]
      def list_transfer_details(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          PayabliSdk::QueryTypes::Types::QueryTransferDetailResponse.load(response.body)
        else
          error_class = PayabliSdk::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      # @option params [String, nil] :sort_by
      #
      # @return [PayabliSdk::Types::TransferQueryResponse]
      def list_transfers(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          PayabliSdk::Types::TransferQueryResponse.load(response.body)
        else
          error_class = PayabliSdk::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      # @option request_options [Hash{String => Object}] :additional_body_parameters
      # @option request_options [Integer] :timeout_in_seconds
      # @option params [PayabliSdk::Types::Orgid] :org_id
      # @option params [PayabliSdk::Types::ExportFormat, nil] :export_format
      # @option params [Integer, nil] :from_record
      # @option params [Integer, nil] :limit_record
      # @option params [Hash[String, String, nil], nil] :parameters
      ...
      # @option params [String, nil] :sort_by
      #
      # @return [PayabliSdk::Types::QueryUserResponse]
      def list_users_org(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          PayabliSdk::Types::QueryUserResponse.load(response.body)
        else
          error_class = PayabliSdk::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      # @option params [String, nil] :sort_by
      #
      # @return [PayabliSdk::Types::QueryResponseVendors]
      def list_vendors(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          PayabliSdk::Types::QueryResponseVendors.load(response.body)
        else
          error_class = PayabliSdk::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      # @option params [String, nil] :sort_by
      #
      # @return [PayabliSdk::Types::VCardQueryResponse]
      def list_vcards(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          PayabliSdk::Types::VCardQueryResponse.load(response.body)
        else
          error_class = PayabliSdk::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
