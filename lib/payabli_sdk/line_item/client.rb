...
module PayabliSdk
  module LineItem
    class Client
      ...
      # @param params [PayabliSdk::Types::LineItem]
      ...
      #
      # @return [PayabliSdk::Types::PayabliApiResponse6]
      def add_item(request_options: {}, **params)
        ...
        request = PayabliSdk::Internal::JSON::Request.new(
          ...
          headers: headers,
          body: PayabliSdk::Types::LineItem.new(body_params).to_h,
        ...
        if code.between?(200, 299)
          PayabliSdk::Types::PayabliApiResponse6.load(response.body)
        else
      ...
      #
      # @return [PayabliSdk::LineItem::Types::DeleteItemResponse]
      def delete_item(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          PayabliSdk::LineItem::Types::DeleteItemResponse.load(response.body)
        else
          error_class = PayabliSdk::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      # @option params [Integer] :line_item_id
      #
      # @return [PayabliSdk::Types::LineItemQueryRecord]
      def get_item(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          PayabliSdk::Types::LineItemQueryRecord.load(response.body)
        else
          error_class = PayabliSdk::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      #
      # @return [PayabliSdk::Types::QueryResponseItems]
      def list_line_items(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          PayabliSdk::Types::QueryResponseItems.load(response.body)
        else
          error_class = PayabliSdk::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      def update_item(request_options: {}, **params)
        ...
        request = PayabliSdk::Internal::JSON::Request.new(
          ...
          method: "PUT",
          path: "LineItem/#{params[:line_item_id]}",
          body: PayabliSdk::Types::LineItem.new(params).to_h,
          request_options: request_options
        )
        begin
          response = @client.send(request)
