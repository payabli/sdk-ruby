...
module PayabliSdk
  module Types
    class NotificationReportRequestContent < Internal::Types::Model
      ...
      field :file_format, -> { PayabliSdk::Types::NotificationReportRequestContentFileFormat }, optional: true, nullable: false, api_name: "fileFormat"
      field :internal_data, -> { Internal::Types::Array[PayabliSdk::Types::KeyValueDuo] }, optional: true, nullable: false, api_name: "internalData"
      field :report_name, -> { PayabliSdk::Types::NotificationReportRequestContentReportName }, optional: true, nullable: false, api_name: "reportName"
