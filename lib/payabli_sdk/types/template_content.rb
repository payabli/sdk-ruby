...
module PayabliSdk
  module Types
    class TemplateContent < Internal::Types::Model
      ...
      field :underwriting_data, -> { PayabliSdk::Types::UnderwritingData }, optional: true, nullable: false, api_name: "underwritingData"
    end
  end
end
