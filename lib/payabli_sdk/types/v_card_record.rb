...
module PayabliSdk
  module Types
    class VCardRecord < Internal::Types::Model
      ...
      field :associated_vendor, -> { PayabliSdk::Types::AssociatedVendor }, optional: true, nullable: false, api_name: "associatedVendor"
      field :associated_customer, -> { PayabliSdk::Types::CustomerData }, optional: true, nullable: false, api_name: "associatedCustomer"
