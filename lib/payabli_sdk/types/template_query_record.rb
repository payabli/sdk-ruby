...
module PayabliSdk
  module Types
    class TemplateQueryRecord < Internal::Types::Model
      ...
      field :boarding_links, -> { Internal::Types::Array[PayabliSdk::Types::BoardingQueryLinks] }, optional: true, nullable: false, api_name: "boardingLinks"
      ...
      field :template_content, -> { PayabliSdk::Types::TemplateContentResponse }, optional: true, nullable: false, api_name: "templateContent"
