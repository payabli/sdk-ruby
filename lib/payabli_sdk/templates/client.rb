...
module PayabliSdk
  module Templates
    class Client
      ...
      #
      # @return [PayabliSdk::Types::PayabliApiResponseTemplateId]
      def delete_template(request_options: {}, **params)
        ...
        if code.between?(200, 299)
          PayabliSdk::Types::PayabliApiResponseTemplateId.load(response.body)
        else
      ...
      #
      # @return [PayabliSdk::Types::BoardingLinkApiResponse]
      def getlink_template(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          PayabliSdk::Types::BoardingLinkApiResponse.load(response.body)
        else
          error_class = PayabliSdk::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      # @option params [Integer] :template_id
      #
      # @return [PayabliSdk::Types::TemplateQueryRecord]
      def get_template(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          PayabliSdk::Types::TemplateQueryRecord.load(response.body)
        else
          error_class = PayabliSdk::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      #
      # @return [PayabliSdk::Types::TemplateQueryResponse]
      def list_templates(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          PayabliSdk::Types::TemplateQueryResponse.load(response.body)
        else
          error_class = PayabliSdk::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
