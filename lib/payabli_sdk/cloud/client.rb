...
module PayabliSdk
  module Cloud
    class Client
      ...
      # @param params [PayabliSdk::Cloud::Types::DeviceEntry]
      ...
      #
      # @return [PayabliSdk::Cloud::Types::AddDeviceResponse]
      def add_device(request_options: {}, **params)
        ...
        request = PayabliSdk::Internal::JSON::Request.new(
          ...
          headers: headers,
          body: PayabliSdk::Cloud::Types::DeviceEntry.new(body_bag).to_h,
        ...
        if code.between?(200, 299)
          PayabliSdk::Cloud::Types::AddDeviceResponse.load(response.body)
        else
      ...
      #
      # @return [PayabliSdk::Types::CloudQueryApiResponse]
      def history_device(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          PayabliSdk::Types::CloudQueryApiResponse.load(response.body)
        else
          error_class = PayabliSdk::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      # @option params [String] :device_id
      #
      # @return [PayabliSdk::Cloud::Types::RemoveDeviceResponse]
      def remove_device(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          PayabliSdk::Cloud::Types::RemoveDeviceResponse.load(response.body)
        else
          error_class = PayabliSdk::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
