...
module PayabliSdk
  module Notification
    class Client
      ...
      # @param params [PayabliSdk::Notification::Types::AddNotificationRequest]
      ...
      #
      # @return [PayabliSdk::Types::PayabliApiResponseNotifications]
      def add_notification(request_options: {}, **params)
        ...
        request = PayabliSdk::Internal::JSON::Request.new(
          ...
          method: "POST",
          path: "Notification",
          body: PayabliSdk::Notification::Types::AddNotificationRequest.new(params).to_h,
        ...
        if code.between?(200, 299)
          PayabliSdk::Types::PayabliApiResponseNotifications.load(response.body)
        else
      ...
      # @option params [String] :n_id
      #
      # @return [PayabliSdk::Types::NotificationQueryRecord]
      def get_notification(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          PayabliSdk::Types::NotificationQueryRecord.load(response.body)
        else
          error_class = PayabliSdk::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      #
      # @param request_options [Hash]
      # @param params [PayabliSdk::Notification::Types::UpdateNotificationRequest]
      # @option request_options [String] :base_url
      # @option request_options [Hash{String => Object}] :additional_headers
      # @option request_options [Hash{String => Object}] :additional_query_parameters
      # @option request_options [Hash{String => Object}] :additional_body_parameters
      ...
      def update_notification(request_options: {}, **params)
        ...
        request = PayabliSdk::Internal::JSON::Request.new(
          ...
          method: "PUT",
          path: "Notification/#{params[:n_id]}",
          body: PayabliSdk::Notification::Types::UpdateNotificationRequest.new(params).to_h,
          request_options: request_options
        )
        begin
          response = @client.send(request)
