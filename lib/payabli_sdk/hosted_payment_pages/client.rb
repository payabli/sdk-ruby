...
module PayabliSdk
  module HostedPaymentPages
    class Client
      ...
      #
      # @return [PayabliSdk::Types::PayabliPages]
      def load_page(request_options: {}, **params)
        ...
        if code.between?(200, 299)
          PayabliSdk::Types::PayabliPages.load(response.body)
        else
      ...
      #
      # @param request_options [Hash]
      # @param params [PayabliSdk::Types::PayabliPages]
      # @option request_options [String] :base_url
      # @option request_options [Hash{String => Object}] :additional_headers
      # @option request_options [Hash{String => Object}] :additional_query_parameters
      # @option request_options [Hash{String => Object}] :additional_body_parameters
      ...
      def new_page(request_options: {}, **params)
        ...
        request = PayabliSdk::Internal::JSON::Request.new(
          ...
          headers: headers,
          body: PayabliSdk::Types::PayabliPages.new(body_params).to_h,
          request_options: request_options
        )
        begin
          response = @client.send(request)
      ...
      def save_page(request_options: {}, **params)
        ...
        request = PayabliSdk::Internal::JSON::Request.new(
          ...
          body: PayabliSdk::Types::PayabliPages.new(params).to_h,
          request_options: request_options
        )
        begin
          response = @client.send(request)
