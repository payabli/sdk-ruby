  ...
  module MoneyIn
    module Types
      ...
      class TransactionDetailPaymentData < Internal::Types::Model
        ...
        field :bin_data, -> { PayabliSdk::Types::BinData }, optional: false, nullable: true, api_name: "binData"
        field :payment_details, -> { PayabliSdk::MoneyIn::Types::TransactionDetailPaymentDetails }, optional: false, nullable: false, api_name: "paymentDetails"
      end
    end
  end
end
