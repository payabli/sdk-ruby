...
module PayabliSdk
  module MoneyIn
    module Types
      ...
      class AuthResponse < Internal::Types::Model
        ...
        field :response_data, -> { PayabliSdk::MoneyIn::Types::AuthResponseResponseData }, optional: false, nullable: false, api_name: "responseData"
      end
    end
  end
end
