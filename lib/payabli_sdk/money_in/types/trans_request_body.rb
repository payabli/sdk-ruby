  ...
  module MoneyIn
    module Types
      class TransRequestBody < Internal::Types::Model
        ...
        field :payment_details, -> { PayabliSdk::Types::PaymentDetail }, optional: false, nullable: false, api_name: "paymentDetails"
        field :payment_method, -> { PayabliSdk::Types::PaymentMethod }, optional: false, nullable: false, api_name: "paymentMethod"
