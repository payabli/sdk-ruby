...
module PayabliSdk
  module MoneyOut
    class Client
      ...
      # @param params [PayabliSdk::MoneyOutTypes::Types::AuthorizePayoutBody]
      ...
      #
      # @return [PayabliSdk::MoneyOutTypes::Types::AuthCapturePayoutResponse]
      def authorize_out(request_options: {}, **params)
        ...
        request = PayabliSdk::Internal::JSON::Request.new(
          ...
          headers: headers,
          query: query_params,
          body: PayabliSdk::MoneyOutTypes::Types::AuthorizePayoutBody.new(params).to_h,
        ...
        if code.between?(200, 299)
          PayabliSdk::MoneyOutTypes::Types::AuthCapturePayoutResponse.load(response.body)
        else
      ...
      # @option request_options [Integer] :timeout_in_seconds
      #
      # @return [PayabliSdk::MoneyOutTypes::Types::CaptureAllOutResponse]
      def cancel_all_out(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          PayabliSdk::MoneyOutTypes::Types::CaptureAllOutResponse.load(response.body)
        else
          error_class = PayabliSdk::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      #
      # @return [PayabliSdk::Types::PayabliApiResponse0000]
      def cancel_out_get(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          PayabliSdk::Types::PayabliApiResponse0000.load(response.body)
        else
          error_class = PayabliSdk::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      #
      # @return [PayabliSdk::Types::BillDetailResponse]
      def payout_details(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          PayabliSdk::Types::BillDetailResponse.load(response.body)
        else
          error_class = PayabliSdk::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      #
      # @return [PayabliSdk::MoneyOutTypes::Types::VCardGetResponse]
      def v_card_get(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          PayabliSdk::MoneyOutTypes::Types::VCardGetResponse.load(response.body)
        else
          error_class = PayabliSdk::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      #
      # @param request_options [Hash]
      # @param params [PayabliSdk::MoneyOut::Types::SendVCardLinkRequest]
      # @option request_options [String] :base_url
      # @option request_options [Hash{String => Object}] :additional_headers
      # @option request_options [Hash{String => Object}] :additional_query_parameters
      # @option request_options [Hash{String => Object}] :additional_body_parameters
      # @option request_options [Integer] :timeout_in_seconds
      #
      # @return [PayabliSdk::MoneyOutTypes::Types::OperationResult]
      def send_v_card_link(request_options: {}, **params)
        ...
        request = PayabliSdk::Internal::JSON::Request.new(
          ...
          body: PayabliSdk::MoneyOut::Types::SendVCardLinkRequest.new(body_bag).to_h,
          request_options: request_options
        )
        begin
          response = @client.send(request)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          PayabliSdk::MoneyOutTypes::Types::OperationResult.load(response.body)
        else
          error_class = PayabliSdk::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
