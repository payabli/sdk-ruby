  ...
  module Bill
    module Types
      class BillResponseData < Internal::Types::Model
        ...
        field :vendor, -> { PayabliSdk::Types::VendorDataResponse }, optional: true, nullable: false, api_name: "Vendor"
        ...
        field :frequency, -> { PayabliSdk::Types::Frequency }, optional: true, nullable: false, api_name: "Frequency"
        field :transaction, -> { PayabliSdk::Types::TransactionOutQueryRecord }, optional: true, nullable: false, api_name: "Transaction"
        field :bill_events, -> { Internal::Types::Array[PayabliSdk::Types::GeneralEvents] }, optional: true, nullable: false, api_name: "billEvents"
        field :bill_approvals, -> { Internal::Types::Array[PayabliSdk::Types::BillQueryRecord2BillApprovalsItem] }, optional: true, nullable: false, api_name: "billApprovals"
        ...
        field :documents_ref, -> { PayabliSdk::Types::DocumentsRef }, optional: true, nullable: false, api_name: "DocumentsRef"
