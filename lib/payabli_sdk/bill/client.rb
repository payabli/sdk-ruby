...
module PayabliSdk
  module Bill
    class Client
      ...
      # @param params [PayabliSdk::Bill::Types::BillOutData]
      ...
      #
      # @return [PayabliSdk::Bill::Types::BillResponse]
      def add_bill(request_options: {}, **params)
        ...
        request = PayabliSdk::Internal::JSON::Request.new(
          ...
          headers: headers,
          body: PayabliSdk::Bill::Types::BillOutData.new(body_params).to_h,
        ...
        if code.between?(200, 299)
          PayabliSdk::Bill::Types::BillResponse.load(response.body)
        else
      ...
      # @option params [Integer] :id_bill
      #
      # @return [PayabliSdk::Bill::Types::EditBillResponse]
      def edit_bill(request_options: {}, **params)
        ...
        request = PayabliSdk::Internal::JSON::Request.new(
          ...
          method: "PUT",
          path: "Bill/#{params[:id_bill]}",
          body: PayabliSdk::Bill::Types::BillOutData.new(params).to_h,
          request_options: request_options
        )
        begin
          response = @client.send(request)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          PayabliSdk::Bill::Types::EditBillResponse.load(response.body)
        else
          error_class = PayabliSdk::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      # @option params [Boolean, nil] :return_object
      #
      # @return [PayabliSdk::Types::FileContent]
      def get_attached_from_bill(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          PayabliSdk::Types::FileContent.load(response.body)
        else
          error_class = PayabliSdk::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      # @option params [Integer] :id_bill
      #
      # @return [PayabliSdk::Bill::Types::GetBillResponse]
      def get_bill(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          PayabliSdk::Bill::Types::GetBillResponse.load(response.body)
        else
          error_class = PayabliSdk::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      #
      # @return [PayabliSdk::Types::BillQueryResponse]
      def list_bills(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          PayabliSdk::Types::BillQueryResponse.load(response.body)
        else
          error_class = PayabliSdk::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      # @option params [Integer] :id_bill
      #
      # @return [PayabliSdk::Bill::Types::ModifyApprovalBillResponse]
      def modify_approval_bill(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          PayabliSdk::Bill::Types::ModifyApprovalBillResponse.load(response.body)
        else
          error_class = PayabliSdk::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      #
      # @return [PayabliSdk::Bill::Types::SetApprovedBillResponse]
      def set_approved_bill(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          PayabliSdk::Bill::Types::SetApprovedBillResponse.load(response.body)
        else
          error_class = PayabliSdk::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
