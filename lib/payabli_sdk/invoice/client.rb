...
module PayabliSdk
  module Invoice
    class Client
      ...
      # @param params [PayabliSdk::Invoice::Types::InvoiceDataRequest]
      ...
      #
      # @return [PayabliSdk::Invoice::Types::InvoiceResponseWithoutData]
      def add_invoice(request_options: {}, **params)
        ...
        request = PayabliSdk::Internal::JSON::Request.new(
          ...
          headers: headers,
          query: query_params,
          body: PayabliSdk::Invoice::Types::InvoiceDataRequest.new(body_params).to_h,
        ...
        if code.between?(200, 299)
          PayabliSdk::Invoice::Types::InvoiceResponseWithoutData.load(response.body)
        else
      ...
      # @option params [Integer] :id_invoice
      #
      # @return [PayabliSdk::Invoice::Types::GetInvoiceRecord]
      def get_invoice(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          PayabliSdk::Invoice::Types::GetInvoiceRecord.load(response.body)
        else
          error_class = PayabliSdk::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      # @option params [String] :entry
      #
      # @return [PayabliSdk::Invoice::Types::InvoiceNumberResponse]
      def get_invoice_number(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          PayabliSdk::Invoice::Types::InvoiceNumberResponse.load(response.body)
        else
          error_class = PayabliSdk::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      #
      # @return [PayabliSdk::Invoice::Types::QueryInvoiceResponse]
      def list_invoices(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          PayabliSdk::Invoice::Types::QueryInvoiceResponse.load(response.body)
        else
          error_class = PayabliSdk::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      #
      # @return [PayabliSdk::Invoice::Types::SendInvoiceResponse]
      def send_invoice(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          PayabliSdk::Invoice::Types::SendInvoiceResponse.load(response.body)
        else
          error_class = PayabliSdk::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
