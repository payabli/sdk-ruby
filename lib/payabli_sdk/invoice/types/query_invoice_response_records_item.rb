  ...
  module Invoice
    module Types
      class QueryInvoiceResponseRecordsItem < Internal::Types::Model
        ...
        field :frequency, -> { PayabliSdk::Types::Frequency }, optional: false, nullable: false
        ...
        field :items, -> { Internal::Types::Array[PayabliSdk::Types::BillItem] }, optional: false, nullable: false
        field :customer, -> { PayabliSdk::Types::PayorDataResponse }, optional: false, nullable: false, api_name: "Customer"
        field :paylink_id, -> { String }, optional: false, nullable: false, api_name: "paylinkId"
        field :bill_events, -> { Internal::Types::Array[PayabliSdk::Types::GeneralEvents] }, optional: false, nullable: false, api_name: "billEvents"
        field :scheduled_options, -> { PayabliSdk::Types::BillOptions }, optional: false, nullable: true, api_name: "scheduledOptions"
        ...
        field :documents_ref, -> { PayabliSdk::Types::DocumentsRef }, optional: false, nullable: true, api_name: "DocumentsRef"
