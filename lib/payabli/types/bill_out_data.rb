...
module Payabli
  module Types
    ...
    class BillOutData < Internal::Types::Model
      ...
      field :scheduled_options, -> { Payabli::Types::BillOutDataScheduledOptions }, optional: true, nullable: false, api_name: "scheduledOptions"
      ...
      field :vendor, -> { Payabli::Types::BillOutDataVendor }, optional: true, nullable: false
    end
  end
end
