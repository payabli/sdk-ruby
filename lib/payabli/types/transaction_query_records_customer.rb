...
module Payabli
  module Types
    class TransactionQueryRecordsCustomer < Internal::Types::Model
      ...
      field :cfee_transactions, -> { Internal::Types::Array[Payabli::Types::QueryCFeeTransaction] }, optional: true, nullable: false, api_name: "CfeeTransactions"

      field :connector_name, -> { String }, optional: true, nullable: false, api_name: "ConnectorName"

      field :customer, -> { Payabli::Types::QueryTransactionPayorDataCustomer }, optional: true, nullable: false, api_name: "Customer"
