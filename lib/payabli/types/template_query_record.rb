...
module Payabli
  module Types
    class TemplateQueryRecord < Internal::Types::Model
      ...
      field :boarding_links, lambda {
        Internal::Types::Array[Payabli::Types::BoardingQueryLinks]
      }, optional: true, nullable: false, api_name: "boardingLinks"
      ...
      field :template_content, lambda {
        Payabli::Types::TemplateContentResponse
      }, optional: true, nullable: false, api_name: "templateContent"
