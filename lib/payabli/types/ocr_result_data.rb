...
module Payabli
  module Types
    class OcrResultData < Internal::Types::Model
      ...
      field :bill_items, -> { Internal::Types::Array[Payabli::Types::OcrBillItem] }, optional: true, nullable: false, api_name: "billItems"
      ...
      field :additional_data, -> { Payabli::Types::OcrBillItemAdditionalData }, optional: true, nullable: false, api_name: "additionalData"

      field :vendor, -> { Payabli::Types::OcrVendor }, optional: true, nullable: false
      ...
      field :attachments, -> { Internal::Types::Array[Payabli::Types::OcrAttachment] }, optional: true, nullable: false
    end
  end
end
