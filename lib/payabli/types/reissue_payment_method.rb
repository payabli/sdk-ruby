...
module Payabli
  module Types
    # Payment method for reissuing a payout transaction. The reissue endpoint uses the payment method details directly.
    # It doesn't fall back to the vendor's managed payment method.
    # - `{ method: "vcard" }` - Reissue as a virtual card
    # - `{ method: "check" }` - Reissue as a paper check
    # - `{ method: "ach", achHolder: "...", achRouting: "...", achAccount: "...", achAccountType: "...", achHolderType:
    # "..." }` - Reissue as ACH with bank details
