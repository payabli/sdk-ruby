...
module Payabli
  module Types
    class DocumentSection < Internal::Types::Model
      ...
      field :upload_documents, lambda {
        Internal::Types::Boolean
      }, optional: true, nullable: false, api_name: "uploadDocuments"
      field :bank_data, -> { Payabli::Types::BankSection }, optional: true, nullable: false, api_name: "bankData"
      field :terms_and_conditions, lambda {
        Payabli::Types::DocumentSectionTermsAndConditions
      }, optional: true, nullable: false, api_name: "termsAndConditions"
      ...
      field :withdrawal_bank, lambda {
        Payabli::Types::BankSection
      }, optional: true, nullable: false, api_name: "withdrawalBank"
    end
  end
end
