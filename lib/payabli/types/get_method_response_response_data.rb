...
module Payabli
  module Types
    class GetMethodResponseResponseData < Internal::Types::Model
      ...
      field :customers, -> { Internal::Types::Array[Payabli::Types::GetMethodResponseResponseDataCustomersItem] }, optional: true, nullable: false
      ...
      field :vendors, -> { Internal::Types::Array[Payabli::Types::GetMethodResponseResponseDataVendorsItem] }, optional: true, nullable: false
    end
  end
end
