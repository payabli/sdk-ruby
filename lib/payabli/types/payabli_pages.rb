  ...
  module Types
    class PayabliPages < Internal::Types::Model
      ...
      field :credentials, lambda {
        Internal::Types::Array[Payabli::Types::PayabliCredentials]
      ...
      field :page_settings, lambda {
        Payabli::Types::PageSetting
      }, optional: true, nullable: false, api_name: "pageSettings"
      field :published, -> { Integer }, optional: true, nullable: false
      field :receipt_content, lambda {
        Payabli::Types::ReceiptContent
      }, optional: true, nullable: false, api_name: "receiptContent"
