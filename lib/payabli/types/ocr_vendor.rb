...
module Payabli
  module Types
    class OcrVendor < Internal::Types::Model
      ...
      field :billing_data, -> { Payabli::Types::OcrVendorBillingData }, optional: true, nullable: false, api_name: "billingData"
      ...
      field :additional_data, -> { Payabli::Types::OcrVendorAdditionalData }, optional: true, nullable: false, api_name: "additionalData"
    end
  end
end
