...
module Payabli
  module Types
    class RequestTokenStorage < Internal::Types::Model
      ...
      field :payment_method, -> { Payabli::Types::RequestTokenStoragePaymentMethod }, optional: true, nullable: false, api_name: "paymentMethod"

      field :vendor_data, -> { Payabli::Types::VendorDataRequest }, optional: true, nullable: false, api_name: "vendorData"
