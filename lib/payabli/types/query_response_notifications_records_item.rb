...
module Payabli
  module Types
    class QueryResponseNotificationsRecordsItem < Internal::Types::Model
      field :content, -> { Payabli::Types::NotificationContent }, optional: true, nullable: false
      field :created_at, -> { String }, optional: true, nullable: false, api_name: "createdAt"
      field :frequency, -> { Payabli::Types::Frequencynotification }, optional: true, nullable: false
      field :last_updated, -> { String }, optional: true, nullable: false, api_name: "lastUpdated"
      field :method_, -> { Payabli::Types::Methodnotification }, optional: true, nullable: false, api_name: "method"
