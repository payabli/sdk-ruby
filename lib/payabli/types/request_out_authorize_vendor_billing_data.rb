...
module Payabli
  module Types
    # Object containing vendor's bank information. This object is deprecated for this endpoint. Use the `paymentMethod`
    # object in payout authorize requests instead.
