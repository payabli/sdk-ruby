...
module Payabli
  module Types
    class PaypointEntryConfig < Internal::Types::Model
      ...
      field :entry_pages, lambda {
        Internal::Types::Array[Payabli::Types::PayabliPages]
      }, optional: true, nullable: false, api_name: "EntryPages"
      ...
      field :paypoint, -> { Payabli::Types::PaypointData }, optional: true, nullable: false, api_name: "Paypoint"
    end
  end
end
