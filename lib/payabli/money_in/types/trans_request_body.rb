  ...
  module MoneyIn
    module Types
      class TransRequestBody < Internal::Types::Model
        ...
        field :payment_details, -> { Payabli::Types::PaymentDetail }, optional: false, nullable: false, api_name: "paymentDetails"
        field :payment_method, -> { Payabli::Types::PaymentMethod }, optional: false, nullable: false, api_name: "paymentMethod"
