  ...
  module Ocr
    module Types
      class OcrResultData < Internal::Types::Model
        ...
        field :bill_items, -> { Internal::Types::Array[Payabli::Ocr::Types::OcrBillItem] }, optional: true, nullable: false, api_name: "billItems"
        ...
        field :additional_data, -> { Payabli::Ocr::Types::OcrBillItemAdditionalData }, optional: true, nullable: false, api_name: "additionalData"
        field :vendor, -> { Payabli::Ocr::Types::OcrVendor }, optional: true, nullable: false
        ...
        field :attachments, -> { Internal::Types::Array[Payabli::Ocr::Types::OcrAttachment] }, optional: true, nullable: false
      end
    end
  end
end
