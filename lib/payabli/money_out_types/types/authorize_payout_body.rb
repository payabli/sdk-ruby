  ...
  module MoneyOutTypes
    module Types
      class AuthorizePayoutBody < Internal::Types::Model
        ...
        field :payment_details, -> { Payabli::MoneyOutTypes::Types::RequestOutAuthorizePaymentDetails }, optional: false, nullable: false, api_name: "paymentDetails"
        ...
        field :invoice_data, -> { Internal::Types::Array[Payabli::MoneyOutTypes::Types::RequestOutAuthorizeInvoiceData] }, optional: false, nullable: false, api_name: "invoiceData"
