...
require_relative "lib/payabli_sdk/version"
...
Gem::Specification.new do |spec|
  spec.name = "payabli_sdk"
  spec.authors = ["PayabliSdk"]
  spec.version = PayabliSdk::VERSION
  spec.summary = "Ruby client library for the PayabliSdk API"
  spec.description = "The PayabliSdk Ruby library provides convenient access to the PayabliSdk API from Ruby."
